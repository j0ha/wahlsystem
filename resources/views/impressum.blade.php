...
<div class="limiter">
    <div class="container-login100" style="background: url({{asset('../img/bg-pattern.png')}}), linear-gradient(to left, #141414, #474747);">
        <div class="container col-md-8 bg-white">
            <div class='impressum'><h1>Impressum</h1><p>Angaben gemäß § 5 TMG</p><p> Einfachabstimmen.online <br>
                    Ahrensburger Weg<br>
                    22359 Hamburg <br>
                    ...
                    Telefon: <br>
                    E-Mail: <a href=':kontakt@einfachabstimmen.online'>kontakt@einfachabstimmen.online</a><br></p><p><strong>
