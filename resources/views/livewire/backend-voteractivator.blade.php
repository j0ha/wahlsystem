                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="float-xl-right float-none mt-xl-0 mt-4">
                                            <button wire:click="aa" style="display: none;">a</button>
                                            <a wire:click="aa" class="btn btn-success">Activate</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card bg-danger-light">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="float-xl-right float-none mt-xl-0 mt-4">
                                            <a onclick="resetMethod()" class="btn btn-success">Ok</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="pl-xl-3">
                                            <div class="m-b-0">
                                                <div class="user-avatar-name d-inline-block">
                                                    <h2 class="font-28 m-b-10">{{$voter->name}} {{$voter->surname}} <b class="text-danger">Already active</b></h2>
                                                </div>
